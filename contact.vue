                ...
                <div class="main_container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="margin_60">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam laoreet tempus accumsan. Donec tincidunt augue ligula, et pulvinar urna maximus sit amet. Vivamus vitae dictum nibh. Pellentesque pharetra ex orci, ut ornare neque sollicitudin sed. Integer eu elit sem. </p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
        ...
        return Vue.component("contact-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', { url: this.property.mm_host + "/pages/greenvalley-contact-us.json" }), this.$store.dispatch("getData", "repos")]);
                        return results;
                    } catch (e) {

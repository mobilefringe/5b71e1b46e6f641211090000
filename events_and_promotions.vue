        ...
        return Vue.component("events-and-promotions-component", {
            ...
            created (){
                this.loadData().then(response => {
                    ...
                    if(temp_repo != null) {
                        ...
                        this.pageBanner = {
                            "image_url": "//codecloud.cdn.speedyrails.net/sites/5ced96a36e6f6437ee020000/image/jpeg/1529532304000/insidebanner2.jpg"
                        }
                    }
            ...
            computed: {
                ...
                eventList: function events() {
                    ...
                    _.forEach(events, function (value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            ...
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5ced96a36e6f6437ee020000/image/png/1542644938364/gvr_events.png";
                            }
                            
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5ced96a36e6f6437ee020000/image/png/1542644938364/gvr_events.png";
                            }
                    ...
                    showEvents = _.orderBy(showEvents, function (o) { return o.end_date }).reverse();
                ...
                promoList: function promos() {
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5ced96a36e6f6437ee020000/image/png/1542644978329/gvr_promos.png";
                            }
                            
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5ced96a36e6f6437ee020000/image/png/1542644978329/gvr_promos.png";
                            }

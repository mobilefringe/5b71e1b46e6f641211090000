                            ...
                            <form id="contest_form" class="form-horizontal clearfix" action="form-submit" v-on:submit.prevent="validateBeforeSubmit">
        						<div class="form-group ">
        							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('first_name')}">
        								...
        								<input id="first_name" v-model="form_data.first_name" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="first_name" type="text" placeholder="First Name" data-vv-delay="500" data-vv-as="first name" required>
        							...
        							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('last_name')}">
        								...
        								<input id="last_name" v-model="form_data.last_name" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="last_name" type="text" placeholder="Last Name" data-vv-delay="500" data-vv-as="last name">
        						...
        						<div class="form-group">
        							<div class="col-xs-12" :class="{'has-error': errors.has('email')}">
        								...
        								<input id="email" v-model="form_data.email" v-validate="'required|email'" class="form-control" :class="{'input': true}" name="email" type="email" placeholder="Email" data-vv-delay="500" data-vv-as="email">
        						...
        						<div class="form-inline row margin_40">
        						    ...
        						    <div class="col-xs-12">
        						        <p>For more details about personal privacy, please read our <a href="/pages/greenvalley-rules-and-regulations" target="_blank">Privacy Policy</a>.</p>
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            created() {
                this.$store.dispatch("getData", "repos").then(response => {
                    ...
                    if(temp_repo != null) {
                        ...
                        this.pageBanner = {
                            "image_url": "//codecloud.cdn.speedyrails.net/sites/5de41d386e6f647ab13c0000/image/jpeg/1529532304000/insidebanner2.jpg"
                        }
                    }
                }, error => {

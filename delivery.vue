                                    ...
                                    <div class="store_logo_container">
                                        <router-link :to="'/stores/'+ store.slug">
                                            ...
                                            <div v-if="!store.no_store_logo">
                                                <img class="transparent_logo" src="//codecloud.cdn.speedyrails.net/sites/5ced96a36e6f6437ee020000/image/png/1536094188000/default_background.png">
                                                <img  class="store_img" :src="store.store_front_url_abs" alt="">
                                            </div>
                                            
                                            <div v-else class="no_logo_container">
                                                <img class="transparent_logo" src="//codecloud.cdn.speedyrails.net/sites/5ced96a36e6f6437ee020000/image/png/1536094188000/default_background.png" alt="">
    ...
    define(["Vue", "vuex", "vue-select", "vue!search-component", "masonry" , "vue-masonry-plugin"], function(Vue, Vuex, VueSelect, SearchComponent, masonry, VueMasonryPlugin) {
        ...
        return Vue.component("dine-component", {
            ...
            computed: {
                ...
                dropDownCats() {
                    var vm = this;
                    var delivery_cat =  _.find(this.processedCategories, function(o) { return _.includes(o.id, vm.deliveryFilter) });
                    var subcategories = [];

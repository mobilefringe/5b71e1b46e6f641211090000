require.config({
    paths: {
        ...
        'image-popup' : 'https://mmvue.codecloudapp.com/image_popup.vue?noext',
    ...
    const vm = new Vue({
        ...
        data: function () {
            return {
                ...
                social_media: [
                    {
                        name: "Facebook",
                        url: "https://www.facebook.com/TheDistrictGVR",
                        iconClass: "fab fa-facebook"
                    },
                    {
                        name: "Instagram",
                        url: "https://www.instagram.com/districtatgvr/",
        ...
        methods: {
            loadData: async function() {
                try{
                    await this.$store.dispatch('initializeApi', { site: "greenvalley", version: "v4" });

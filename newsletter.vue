                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="newsletter_form form-horizontal" action="//mobilefringe.createsend.com/t/d/s/kkuyhl/" method="post">
                                <div class="row">
                                    <div class="col-sm-6" >
                                        <label for="fieldwldtru" class="visuallyhidden">First Name</label>
                                    ...
                                    <div class="col-sm-6" >
                                        <label for="fieldwldtyl" class="visuallyhidden">Last Name</label>
        ...
        return Vue.component("newsletter-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/greenvalley-newsletter.json"}), this.$store.dispatch("getData", "repos")]);
                        return results;
                    } catch (e) {

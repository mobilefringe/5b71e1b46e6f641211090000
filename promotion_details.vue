                    ...
                    <div v-if="currentPromo">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <p class="event_dates" v-if="isMultiDay(currentPromo)">{{ currentPromo.start_date | moment("MMMM D", timezone)}} - {{ currentPromo.end_date | moment("MMMM D", timezone)}}</p>
                ...
                currentPromo : function (){
                    if(this.currentPromo != null) {
                        if (this.currentPromo.promotionable_type === "Store"){
                            ...
                            if  (_.includes(this.currentPromo.promo_image_url_abs, 'missing')) {
                                this.currentPromo.image_url = "//codecloud.cdn.speedyrails.net/sites/5de41d386e6f647ab13c0000/image/png/1529532181000/promoplaceholder2@2x.png";    
                            }
                        }
                    }
                }

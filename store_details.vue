                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div id="map" class="margin_20">
                                <mapplic-map ref="svgmap_ref" :height="314" :minimap= "false" :deeplinking="false" :sidebar="false" :hovertip="true" :maxscale= "5" :storelist="processedStores" :floorlist="floorList" :svgWidth="2500" :svgHeight="2000" @updateMap="updateSVGMap" :key="currentStore.id"></mapplic-map>
                            </div>
                ...
                currentStore: function () {
                    ...
                    _.forEach(this.currentStore.promotions, function(value, key) {
                        ...
                        if (_.includes(current_promo.image_url, 'missing')) {
                            current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5ced96a36e6f6437ee020000/image/png/1529532181000/promoplaceholder2@2x.png";
                        }
                    ...
                    _.forEach(this.currentStore.events, function(value, key) {
                        ...
                        if (_.includes(current_event.image_url, 'missing')) {
                            current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5ced96a36e6f6437ee020000/image/png/1529532187000/eventsplaceholder2@2x.png";
                        }
